...
export class initialMigration1663096994478 implements MigrationInterface {
    name = 'initialMigration1663096994478'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "password" character varying NOT NULL, "userName" character varying NOT NULL, "first_Login" boolean NOT NULL DEFAULT true, "type" character varying NOT NULL, "isActive" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "psychologist" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "img" character varying NOT NULL, "emphasis" character varying NOT NULL, "experience" character varying NOT NULL, "available_times" character varying NOT NULL, "working_days" text array NOT NULL, "registration" character varying NOT NULL, "meeting" character varying NOT NULL, "userId" uuid, CONSTRAINT "REL_7b8523eebfcf62ca5e6ea1f3e9" UNIQUE ("userId"), CONSTRAINT "PK_8306b92077e64754cda381819cf" PRIMARY KEY ("id"))`);
